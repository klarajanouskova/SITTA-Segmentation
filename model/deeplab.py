...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.layer5 = self._make_pred_layer(ClassifierModule, [6, 12, 18, 24], [6, 12, 18, 24], num_classes)
...
def download_gta5_model():
    url = 'https://download.europe.naverlabs.com/oasis/dr2_model.pth'
    wgetpp(url, '../ckpts/gta5')
